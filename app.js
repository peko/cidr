...
var CidrCanvas, cidr2range, cidr_cvs, cidrs, cidrs_change, cidrs_sel, clear_btn, colors_sel, cursor_ip, cvs, d2xy, draw, draw_btn, get_file, hex2color, ip2dec, ip2hex, res_change, res_sel, rot, xy2d,
  __slice = [].slice,
...
CidrCanvas = (function() {
  ...
  CidrCanvas.prototype.res = function(size) {
    this.size = size;
    this.h = this.w = this.cvs.height = this.cvs.width = 1 << (8 + this.size);
    return this.b = cvs.getBoundingClientRect();
  };

  CidrCanvas.prototype.plot_cidrs = function(cidrs, color) {
  ...
  CidrCanvas.prototype.clear = function() {
    this.ctx.fillStyle = "#000";
    return this.ctx.fillRect(0, 0, this.w, this.h);
  };

  CidrCanvas.prototype.mousemove = function(e) {
    var ip, x, y;
    ...
    return cursor_ip.innerHTML = "" + (ip2dec(ip));
  };
...
draw = function() {
  ...
  return cidr_cvs.plot_cidrs(data, color);
};
  ...
  (function(_this) {
    return (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        ...
        filename: "/home/peko/lab/cidr/app.coffee"
      });
...
res_change = function() {
  ...
  return cidr_cvs.res(parseInt(value));
};
